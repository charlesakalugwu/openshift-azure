...
func mergePropertiesAdmin(oc *OpenShiftManagedCluster, cs *api.OpenShiftManagedCluster) error {
	...
	if oc.Properties.MonitorProfile != nil {
		if oc.Properties.MonitorProfile.WorkspaceID != nil {
			cs.Properties.MonitorProfile.WorkspaceID = *oc.Properties.MonitorProfile.WorkspaceID
		}
	}
...
func mergeImageConfig(in *ImageConfig, out *api.ImageConfig) {
	...
	if in.MonitorAgent != nil {
		out.MonitorAgent = *in.MonitorAgent
	}
	return
}
